...
public class TurnosTestIntegracion {
    ...
    public void cargarDatos() {
        Paciente paciente = pacienteService.guardarPaciente(new Paciente("Jorgito", "Pereyra", "1111111", LocalDate.of(2024, 9, 11), new Domicilio("calle 1", 12, "La Rioja", "Argentina"), "jorgito@digitalhouse.com"));
        Odontologo odontologo = odontologoService.guardarOdontologo(new Odontologo("Matias", "Torres", "1223"));
        Turno turno = turnoService.registrarTurno(new Turno(paciente,odontologo,LocalDate.of(2024,9,21)));
    }
